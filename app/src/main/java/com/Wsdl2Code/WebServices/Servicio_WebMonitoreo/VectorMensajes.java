...
public class VectorMensajes extends Vector<Mensajes> implements KvmSerializable {
    
    
    public VectorMensajes(){}
    
    public VectorMensajes(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){

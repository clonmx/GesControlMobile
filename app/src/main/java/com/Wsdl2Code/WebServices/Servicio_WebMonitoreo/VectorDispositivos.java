...
public class VectorDispositivos extends Vector<Dispositivos> implements KvmSerializable {
    
    
    public VectorDispositivos(){}
    
    public VectorDispositivos(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    Dispositivos j1= new Dispositivos(j0);
                    add(j1);
                }
            }
        }
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        info.name = "Dispositivos";
        info.type = Dispositivos.class;
    }
